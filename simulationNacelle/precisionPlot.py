...
from simulationNacelle.equationMotion import L1, L2, L3, belowD1, belowD2, aboveD3, u1, u2, u3, calculatePrecision3
...
for i in range(nbPoints):
    ...
    for j in range(nbPoints):
        ...
        if None not in [valueL1, valueL2, valueL3]:
            row.append(calculatePrecision3(x[j], y[i], z))
        else:
            row.append(None)
